...
const HireMe = () => {
  return (
    <div className='absolute lg:fixed flex items-center justify-center overflow-hidden right-0 left-auto -top-4 bottom-auto lg:left-4 lg:bottom-4 lg:right-auto lg:top-auto'>
